...
//CODE HERE
let greaterThanFive = function(num1){
  if(num1 > 5){
    return true
  } else{
    return false;
...
//CODE HERE
let findZWords = function(word){
  if(word[0].toLowerCase() === "z"){
    return `the name begins with Z`
  } else{
    return `the name doesnt begin with Z`
  }
}

// console.log(findZWords('Zander'))
//////////////////PROBLEM 4////////////////////
/*
